...
export default function AuthTemplate({
    ...
    return (
        <div className='fade-in container pl-0 flex max-w-6xl dark:bg-base-50 mt-16 rounded-lg dark:border-base-content dark:border-opacity-10 shadow-md dark:bg-opacity-20'>
            ...
            <section className='flex-1 p-10'>
                <div className='dark:bg-primary-focus rounded-lg shadow-lg dark:text-white flex flex-col items-center justify-around text-center p-6'>
                    ...
                    <div className='dark:bg-primary dark:bg-opacity-50 p-2 rounded-full w-80 h-80 my-8 flex justify-center items-center'>
                        <div className='dark:bg-primary dark:bg-opacity-90 p-2 rounded-full w-72 h-72 my-6 flex justify-center dark:border-white border dark:border-opacity-10'>
                            <Image
                                priority
                                width={1000}
                                height={1000}
